...
<body>
        ...
        <div class="userlogin">
            <div class="header-container">
                ...
                <article>
                    ...
                    <a href="../crews/roger.php" class="active">Roger Pirates</a>
    ...
    <section class="container">
        <div class="body-container-crews">
            <article>
                <h1 class="body-title">Roger Pirates</h1>
            </article>
            <article class="crew-info-container">
                <div class="crew-info">
                    <img src="../assets/img/roger/roger-flag.jpg" alt="">
                    <div class="crew-body">
                        The Roger Pirates were the pirate crew of Gol D. Roger. They were, and still are, the only known crew to ever reach Laugh Tale, the end of the New World in the Grand Line.
                    </div>
                </div>
                <div class="crew-info">
                    <img src="../assets/img/roger/roger-ship.webp" alt="">
                    <div class="crew-body">
                        The Roger Pirates' ship, the Oro Jackson, was constructed by the most skilled shipwright of the era, Tom.
                    </div>
                </div>
                <div class="crew-info">
                    <img src="../assets/img/roger/roger-captain.png" alt="">
                </div>
                <div class="crew-info">
                    <img src="../assets/img/roger/roger-vicecaptain.jpg" alt="">
                </div>
            </article>
        </div>
    </section>
